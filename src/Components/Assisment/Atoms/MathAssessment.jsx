            ...
            <div className='d-flex flex-column gap-3'>
                ...
                <div className='d-flex justify-content-between p-2 border-top'>
                    ...
                    <div className='d-flex  gap-3 align-items-center '>
                        <button className='d-flex align-items-center border  gap-2 btn-sm rounded-pill btn btn-outline'>
                            <i className='bi bi-link'></i>
                            <div>Share</div>
                        </button>

                        <div className=' position-relative'>
                            <div className='rounded-circle d-flex justify-content-center align-items-center text-white position-absolute  fw-medium  p-2' style={{ backgroundColor: "#3079a1", left: "-25px", bottom: "-15px", height: "30px", width: "30px" }}>{share}</div>
                            <div className='rounded-circle d-flex justify-content-center align-items-center text-white position-absolute fw-medium p-2' style={{ backgroundColor: "#6548ee", left: "-13px", bottom: "-15px",height: "30px", width: "30px" }}>{share}</div>
                            <div className='rounded-circle d-flex justify-content-center align-items-center text-white position-absolute fw-medium p-2' style={{ backgroundColor: "#e9407a", left: "0px", bottom: "-15px",height: "30px", width: "30px" }}>{share}</div>
                        </div>
                    </div>
                </div>
            </div>
